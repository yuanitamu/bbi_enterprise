<form class="form-horizontal" action="<?php echo site_url('warehouse/add_stok_produk'); ?>" method="post" enctype="multipart/form-data">
			...
			<div class="portlet box green">
				...
				<div class="portlet-body form" style="display: block;">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input class="span5 m-wrap" type="text" name="stok" placeholder="Nama" />
						</div>
					</div>
					<div class="control-group">
