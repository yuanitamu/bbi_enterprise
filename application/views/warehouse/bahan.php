<form class="form-horizontal" action="<?php echo site_url('warehouse/request_bahan'); ?>" method="post" enctype="multipart/form-data">
	...
	<div class="row-fluid">
		<div class="form-actions">
			<input type="text" name="kategori" value="2" style="display:none" />
