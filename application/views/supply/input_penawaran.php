<form class="form-horizontal" action="<?php echo site_url('supply/add_penawaran'); ?>" method="post" enctype="multipart/form-data">
			...
			<div class="portlet box green">
				...
				<div class="portlet-body form" style="display: block;">
					<div class="control-group">
						<label class="control-label">ID Tender</label>
						<div class="controls">
							<select class="span5 chosen" name="tender" data-placeholder="Choose a Category">
								<?php foreach ($tender as $key => $value) {
								?>
